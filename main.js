...
const sess = `${opts._[0] || 'session'}.data.json`
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = '⛦┉┉┉┉┉┉[ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ɢʀᴏᴜᴘ. ᴜᴍᴍ ]┉┉┉┉┉┉⛦\n\n┏––––––┉┉┉┉┉┉━━•\n│☘︎ @subject\n┣┉┉┉┉┉┉━━┅┅┅\n│( 👋 Hallo @user)\n├[ ɪɴᴛʀᴏ ]—\n│ ɴᴀᴍᴀ: \n│ ᴜᴍᴜʀ: \n│ ɢᴇɴᴅᴇʀ:\n┗––––––━━┅┅┅\n\n––––––┅┅ ᴅᴇsᴄʀɪᴘᴛɪᴏɴ ┅┅––––––\n@desc'
  conn.bye = '⛦┉┉┉┉┉┉[ ʙʏᴇ ʜᴛᴛᴘ ]┉┉┉┉┉┉⛦\n𝚂𝚊𝚢𝚘𝚗𝚊𝚛𝚊𝚊 @user 😼👋'
  conn.spromote = '@user ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀɴ ᴀᴅᴍɪɴ!'
  conn.sdemote = '@user ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴀɴ ᴀᴅᴍɪɴ!'
  conn.sDesc = 'sᴜᴄᴄᴇs \n@desc'
  conn.sSubject = 'sᴜᴄᴄᴇs \n@subject'
  conn.sIcon = 'sᴜᴄᴄᴇs!'
  conn.sRevoke = 'ᴏᴏʜ \n@revoke'
...
_quickTest()
    .then(() => conn.logger.info('☑️ ϙᴜɪᴄᴋ ᴛᴇsᴛ ᴅᴏɴᴇ , sᴇssɪᴏɴ ɴᴀᴍᴇ: ~> creds.json'))
    .catch(console.error)
