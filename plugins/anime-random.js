...
conn.sendButton(m.chat, '*Random Pic >* ' + command, author, haha.data, [['ðŸ”„ NEXT ðŸ”„', `/${command}`]], m)}
if (command == 'akiyama') {
...
conn.sendButton(m.chat, '*Random Pic >* ' + command, author, haha.data, [['ðŸ”„ NEXT ðŸ”„', `/${command}`]], m)}
if (command == 'hinata') {
let haha = hinata.getRandom()
conn.sendButton(m.chat, '*Random Pic >* ' + command, author, haha, [['ðŸ”„ NEXT ðŸ”„', `/${command}`]], m)}  
if (command == 'inori') {
...
conn.sendButton(m.chat, '*Random Pic >* ' + command, author, haha.data, [['ðŸ”„ NEXT ðŸ”„', `/${command}`]], m)}  
if (command == 'kurumi') {
let haha = await conn.getFile(`https://arifzyn-api.herokuapp.com/api/wallpaper/kurumi?apikey=BetaBotz`)
conn.sendButton(m.chat, '*Random Pic >* ' + command, author, haha.data, [['ðŸ”„ NEXT ðŸ”„', `/${command}`]], m)}  
if (command == 'madara') {
