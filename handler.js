...
const fgclink = {
  ...
  if (rown) return conn.reply(m.chat, ucapan() + tag + '\n' + rown, fkontak)
...
let prm = {
        premium: '[ PREMIUM USER ONLY ]\n\n🚩 Menggunakan fitur ini di private chat hanya untuk pengguna premium, upgrade ke paket premium hanya Rp. 10.000,- untuk mendapatkan batas 1K selama 1 bulan.\n\nJika anda ingin membeli paket premium silahkan kirim *.sewabot*'}[type]
  if (prm) return conn.reply(m.chat, prm, fakes)
